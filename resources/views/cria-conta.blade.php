...
<!-- Hero -->
<div class="relative bg-gradient-to-bl from-yellow via-transparent dark:from-yellow-400 :via-transparent">
    ...
    <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        ...
        <div class="mt-4 md:mb-12 max-w-2xl">
          ...
          <p class="text-black ">
          Fornecemos a você uma imensão variedades de produtos. Nosso foco principal é superar as expectativas dos clientes.
          </p>
        </div>
        <!-- End Title -->                                                                                                                                                      
          ...
          <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
            ...
            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-neutral-900">
              <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Conta Google</h1>
              ...
              <div class="mt-5">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <label for="hs-hero-signup-form-floating-input-first-name" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Primeiro nome</label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End Input Group -->
                  ...
                  <div>
                    ...
                    <div class="relative">
                      ...
                      <label for="hs-hero-signup-form-floating-input-last-name" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Sobrenome</label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End Input Group -->
                  ...
                  <div class="relative col-span-full">
                    ...
                    <div class="relative">
                      ...
                      <label for="hs-hero-signup-form-floating-input-new-password" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Nova Senha</label>
                    </div>
                  ...
                  <div class="col-span-full">
                    ...
                    <div class="relative">
                      ...
                      <label for="hs-hero-signup-form-floating-input-current-password" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500"> Repetir Senha </label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End Input Group -->
                  <div class="mt-5">
                <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-700 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                ...
                <div class="mt-3 flex items-center">
                  ...
                  <div class="ms-3">
                    <label for="remember-me" class="text-sm dark:text-white">Eu aceito o <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="#">Terms and Conditions</a></label>
                  </div>
                </div>
                <!-- End Checkbox -->
